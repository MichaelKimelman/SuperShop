...
namespace StefansSuperShop.Migrations
{
    ...
    [Migration("20230105150323_NullableWishlistId")]
    partial class NullableWishlistId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StefansSuperShop.Data.ExtendedUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StefansSuperShop.Data.Newsletter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Message = "This is our second newsletter!",
                            Title = "Newsletter 2"
                        });
                });

            modelBuilder.Entity("StefansSuperShop.Data.NewsletterSubscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StefansSuperShop.Data.Subscriber", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Email = "sven.svensson@mail.se"
                        },
                        new
                        {
                            Id = 2,
                            Email = "karl.karlsson@mail.se"
                        },
                        new
                        {
                            Id = 3,
                            Email = "anders.andersson@mail.se"
                        },
                        new
                        {
                            Id = 4,
                            Email = "magnus.magnusson@mail.se"
                        },
                        new
                        {
                            Id = 5,
                            Email = "johan.johansson@mail.se"
                        },
                        new
                        {
                            Id = 6,
                            Email = "mats.matsson@mail.se"
                        });
                });
            ...
            modelBuilder.Entity("StefansSuperShop.Data.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExtendedUserId = "80e9ddc5-feec-4624-87d8-6000c82c0ef4",
                            ProductId = 1
                        },
                        new
                        {
                        ...
                        {
                            Id = 5,
                            ExtendedUserId = "eba557ce-b4ad-42cc-a6be-7e80d2b304d1",
                            ProductId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StefansSuperShop.Data.ExtendedUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StefansSuperShop.Data.NewsletterSubscriber", b =>
                {
                    b.HasOne("StefansSuperShop.Data.Newsletter", "Newsletter")
                        .WithMany()
                        .HasForeignKey("NewsletterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StefansSuperShop.Data.Subscriber", "Subscriber")
                        .WithMany()
            ...
            modelBuilder.Entity("StefansSuperShop.Data.Subscriber", b =>
                {
                    b.HasOne("StefansSuperShop.Data.ExtendedUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
